...
class DataIngestion():
    ...
    def split_data(self):
        try:
            logger.info("Staarting splitting process")
            ...
            raise CustomException("Failed to split data into training and test dataset", e)
    ...
    def run(self):
        try:
            ...
            self.split_data()
            logger.info("Completed data ingestion process")
